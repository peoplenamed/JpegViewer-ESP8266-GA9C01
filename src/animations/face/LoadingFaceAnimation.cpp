...
// void LoadingFaceAnimation::getPixels(Pixel *&pixels, int frame, uint16_t foreground, uint16_t background) {
// 	switch(frame)
// 	{
// 		case 1:
// 		case 2:
...
// 			eyeLeftElement.getPixels(*&pixels, getRandomEyeType(), foreground, background);
// 			eyeRightElement.getPixels(*&pixels, getRandomEyeType(), foreground, background);
// 			break;
// 		case 16:
// 		case 20:
// 		case 24:
