...
void EyeElement::render(EyeType type)
{
	...
	{
	case EYE_OPEN_LR:
		gfx->drawBitmap(x, y, eye_open_lr, 64, 54, WHITE);
		break;
	case EYE_ANGRY_R:
		gfx->drawBitmap(x, y, eye_angry_r, 64, 54, WHITE);
		break;
	case EYE_ANGRY_L:
		gfx->drawBitmap(x, y, eye_angry_l, 64, 54, WHITE);
		break;
	case EYE_DISAPPOINTED_LR:
		gfx->drawBitmap(x, y, eye_disappointed_lr, 64, 54, WHITE);
		break;
	case EYE_SATISFIED_LR:
		gfx->drawBitmap(x, y, eye_satisfied_lr, 64, 54, WHITE);
		break;
	case EYE_DIAMOND_LR:
		gfx->drawBitmap(x, y, eye_dimond_lr, 64, 54, WHITE);
		break;
	case EYE_CLOSING_LR:
		gfx->drawBitmap(x, y, eye_closing_lr, 64, 54, WHITE);
		break;
	case EYE_CLOSED_LR:
		gfx->drawBitmap(x, y, eye_closed_lr, 64, 54, WHITE);
		break;
	case EYE_POP_ONE_LR:
		gfx->drawBitmap(x, y, eye_pop_one_lr, 64, 54, WHITE);
		break;
	case EYE_POP_TWO_LR:
		gfx->drawBitmap(x, y, eye_pop_two_lr, 64, 54, WHITE);
		break;
	case EYE_SPIRAL_ONE_LR:
		gfx->drawBitmap(x, y, eye_spiral_one_lr, 64, 54, WHITE);
		break;
	case EYE_SPIRAL_TWO_LR:
		gfx->drawBitmap(x, y, eye_spiral_two_lr, 64, 54, WHITE);
		break;
	case EYE_SPIRAL_THREE_LR:
		gfx->drawBitmap(x, y, eye_spiral_three_lr, 64, 54, WHITE);
		break;
	case EYE_SPIRAL_FOUR_LR:
		gfx->drawBitmap(x, y, eye_spiral_four_lr, 64, 54, WHITE);
		break;
	default:
		gfx->drawBitmap(x, y, eye_open_lr, 64, 54, WHITE);
		break;
